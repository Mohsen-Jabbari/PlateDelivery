            ...
            else if (TopYarTmpViewModel.ProvinceMessage == null)
            {
                ...
                else
                {
                    if (TopYarTmpViewModel.IbanMessage == null)
                    {
                        ...
                        var services = _serviceCodingService.GetServiceCodings(1, 1000, "", "").ServiceCodings.Select(s => s.ServiceCode).Distinct().ToList();
                        TopYarTmpViewModel = _topYarTmpService.GetTopYarTmps();
                        ...
                        if (TopYarTmpViewModel.ServiceMessage == null)
                        {
                            ...
                            var newService = _serviceCodingService.GetServiceCodingsExceptParking(1, 1000, "", "").ServiceCodings
